...
ex _f   CBL [MLOC];                    // массив локальных переменных каналов
ex _i   HCSE;                          // кол-во контроллеров в базе каналов
ex _i   HSRV;                          // кол-во контроллеров для запросов по UDP 
ex uc   NMWS [16];                     // имя NetBIOS этой рабочей станции
//---------------------------------------------------------------------------
